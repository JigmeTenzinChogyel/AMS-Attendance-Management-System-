...
function StudentAttendance({filter}) {
  ...
  // const filteredData = {}
  // if (filter.programme != "" && filter.programme == studentDetails.programme) {
  //   filteredData.programme = studentDetails.programme
  // }
  // if (filter.gender != "" && filter.gender == studentDetails.gender) {
  //   filteredData.gender = studentDetails.gender
  // }
  // if (filter.semester != "" && filter.semester == studentDetails.semester) {
  //   filteredData.semester = studentDetails.semester
  // }
